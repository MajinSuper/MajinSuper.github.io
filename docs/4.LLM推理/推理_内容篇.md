...
permalink: /article/llm_inference_content/
---
...
| 结构化输出（chat completions api） | 定义Pydantic类，自动将其转成schema                           | **from pydantic import BaseModel**<br/>**class DateEvent(BaseModel):<br/>&emsp;name: str<br/>&emsp;date: str<br/>&emsp;person_list: list[str]**<br/>response = **client.beta.chat.completions.parse**(<br/>&emsp;…<br/>&emsp;**response_format= DateEvent**<br/>)<br/>response.output_parsed<br/>#*name='科学展' date='周五' person_list=['小王', '小李']* |
| 结构化输出（responses api）        | 定义Pydantic类，自动将其转成schema                           | response = **client.reponses.parse**(<br>&emsp;…<br>&emsp;**text_format = DateEvent**<br>)<br>response.output_parsed<br>#*name='科学展' date='周五' person_list=['小王', '小李']* |
|                                    |                                                              |                                                              |
